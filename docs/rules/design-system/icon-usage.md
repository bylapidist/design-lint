...
*This rule provides fixes when the replacement component is already in scope. Both self-closing tags and paired open/close tags are auto-fixed independently (each part of a paired tag is fixed separately).*
